        ...
        <div className={cn(
          ...
          <div className="space-y-12">
            ...
            {(sharedSong.title || sharedSong.description) && (
              <div className="bg-muted/20 border border-border/80 rounded-lg p-8 backdrop-blur-sm">
            ...
            {/* Call to Action */}
            <div className="bg-primary/8 border border-primary/50 rounded-lg p-8 backdrop-blur-sm text-center">
              <div className="space-y-6">
                <div>
