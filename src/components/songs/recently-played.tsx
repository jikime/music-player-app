  ...
  return (
    <div className="mb-8">
      ...
      >
        ...
        >
          <div className="flex gap-3 sm:gap-4 overflow-x-auto scrollbar-hide justify-center mb-4">
            {currentSongs.map((song) => (
              <div
                key={song.id}
                className="md:bg-card/50 md:border-border md:hover:bg-card/80 hover:scale-105 md:hover:scale-100 transition-all cursor-pointer md:rounded-xl md:border md:shadow-sm flex flex-col w-28 sm:w-32 md:w-52 lg:w-56 flex-shrink-0"
